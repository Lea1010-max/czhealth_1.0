...
public class QiNiuUtils {
    ...
    private static final String ACCESSKEY = "RwHAc9LP-za5Kd3O0LUZoXfXb5LJ-2pKEdQmTuVP";
    private static final String SECRETKEY = "bTppu-MqD4fGThcVKUgqZIbd06DKybRpYmYjTxUQ";
